...
def escape_regex_string(regex_string):
    """
    Given a string, steps through it and escapes any characters that are special
    regex characters. Note: This handles most cases, but does not handle complex
    regex patterns that may need more sublte handling. Buyer beware.

    :param regex_string: The string to escape. May be of any length and contain
           any characters.
